...
public class RenderBobble extends TileEntitySpecialRenderer {
	...
	public static final ResourceLocation bobble_var = new ResourceLocation(RefStrings.MODID, "textures/models/trinkets/var.png");
	...
	public void renderBobble(BobbleType type) {
		...
		case VAR:		bindTexture(bobble_var); break;
	...
	public void setupFigurineRotation(BobbleType type) {
		...
		case VAER:
			...
			/*
		case VAR:
				rotLeftArm = new double[]{90, -45, 0};
				rotRightArm = new double[]{90, -45, 0};
			break;
			*/
		}
	}
